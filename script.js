...
window.onscroll = function() {
    ...
    if (window.pageYOffset > headerSection.offsetHeight - 75) {
        ...
        logoImage.src = "https://res.cloudinary.com/abdel-rahman-ali/image/upload/v1535988525/logo-lilac.png";
    } else {
        nav.classList.remove("active");
        logoImage.src = "https://res.cloudinary.com/abdel-rahman-ali/image/upload/v1535988515/logo-lilac-white.png";
    }
    ...
    // home page JS
    if (pageTitle.text === "LILAC- Restaurant") {
